...
if __name__ == '__main__':
    ...
    short_texts = ['Nos vemos el próximo martes, 21/05/23, para discutir los detalles del proyecto.',
                   'El concierto de tu banda favorita será el diez de junio de este año. ¡No te lo puedes perder!',
                   'El plazo de entrega de la tarea es el uno de julio. Recuerda enviarla a tiempo.',
    ...
    mid_texts = ['¡Estoy emocionado! El próximo viernes, veintiocho de septiembre de 2023, se llevará a cabo el festival de música más grande de la ciudad. Habrá bandas en vivo, food trucks y actividades para toda la familia. No puedo esperar para disfrutar de una noche llena de diversión y buena música.',
